...
export default class AllianceEventList extends Component <{}> {
    ...
    componentWillMount(): void {
        this.setState({
            banners: [
                { key: '1', title: '새우꺾기', subTitle: '입안 가득 느껴지는 새우의 담백한 맛', imageSource: require('../../image/shrimp_al.jpeg'), location: '공릉동',
                    subLocation: '공릉역 5분거리', amount: '10%', eventType:'OFF', studentLimit: true, start: '2018.09.03', end: '2018.12.23' },
                { key: '2', title: '플라잉볼', subTitle: '계란 요리의 진수', imageSource: require('../../image/flyingball_al.jpg'), location: '공릉동',
                    subLocation: '공릉동 철길 거리', amount: '10%', eventType:'OFF', studentLimit: true, start: '2018.08.03', end: '2018.12.29' },
                { key: '3', title: '열화철판', subTitle: '곱창 맛 하나로 성공한집', imageSource: require('../../image/fire_al.jpg'), location: '공릉동',
                    subLocation: '서울과학기술대학교 삼거리', amount: '20%', eventType:'OFF', studentLimit: true, start: '2018.11.10', end: '2019.01.05' },
            ],
        });
    }
